...
![Android Studio 运行环境](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-052.png)
*Android Studio AVD + Apple Music 运行环境：Pixel 8 Pro 模拟器上播放 ALAC 无损音频*
...
![Apple Music 音质设置](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-000.png)
...
![Jadx 反编译 FootHillDecryptionKey](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-002.png)
*Jadx-GUI 中反编译得到的 FootHillDecryptionKey 类*

![FootHillDecryptionKey 类结构](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-042.png)
...
![Gemini 分析 FootHillDecryptionKey 调用流程](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-004.png)
*Gemini 2.5 Pro 分析的 FootHillDecryptionKey 9 步调用流程：从 getKey() 到 decryptContext*

![getKey() 源码中的 generateSessionContext](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-006.png)
...
![IDA Pro 函数列表](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-009.png)
...
![radare2 过滤结果](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-010.png)
*radare2 终端过滤 foothill|decrypt 相关函数*
...
![objection 拦截 getFpsCert](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-005.png)
*objection 拦截 getFpsCert 输出：backtrace 和 FPS 证书返回值*
...
![分组 hook 日志结果](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-014.png)
*g1.log：第一组函数的 hook 结果*

![分组 hook 与 Apple Music 日志对比](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-012.png)
...
![SVDecryptorType 枚举](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-028.png)
*SVDecryptorType 枚举定义：DECRYPTOR_TYPE_PASTIS_TS = 0x05 高亮*

![SVBuffer::buffer 实现](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-050.png)
*IDA 伪代码：SVBuffer::buffer 返回 `*(_QWORD *)this + 4`*

![SVBuffer::size 实现](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-051.png)
...
![IDA arm getPersistentKey 参数列表](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-032.png)
*IDA Pro arm 架构下 getPersistentKey 函数定义：9 个参数红框标注*

![Frida getPersistentKey 调用输出](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-040.png)
*Frida 拦截输出：getPersistentKey → instanceEv → decryptContext 的完整调用链及参数*

![getPersistentKey 返回值](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-043.png)
...
![IDA x86 decryptContext 参数](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-033.png)
*IDA Pro x86 decryptContext 函数签名：3 个参数*

![IDA decryptContext 实现](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-027.png)
*IDA Pro decryptContext 实现：decryptContentType 分支逻辑*

![Frida decryptContext 返回值](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-045.png)
...
![IDA kdContext x86 实现](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-036.png)
*IDA Pro x86 kdContext 伪代码：`return (__int64)this + 24`*

![radare2 验证偏移量](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-047.png)
*radare2 计算确认：0x4b0 - 0x498 = 24，与 IDA 伪代码一致*

![Frida kdContext hook 输出](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-046.png)
...
![IDA NfcRKV 伪代码](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-037.png)
...
![Frida hook 完整输出](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/screenshots/img-049.png)
...
![FairPlay DRM 解密流程](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/decrypt-flow.png)
*完整的 FairPlay DRM 解密时序：从播放器请求到白盒 AES 解密。注意 N 函数的 v7 和 v8 指向同一个 buffer——这就是 in-place 解密的证据。*
...
![逆向分析四阶段](https://overkazaf.github.io/blogs/images/fairplay-drm-reversing/analysis-phases.png)
*四个分析阶段：静态分析（Jadx + IDA）→ 动态调试（Frida 分组 hook）→ 参数还原（x86/arm 对比）→ 验证 dump。每个阶段的关键发现标注在右侧。*
