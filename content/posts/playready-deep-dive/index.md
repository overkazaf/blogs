...
1. [Microsoft PlayReady Documentation](https://learn.microsoft.com/en-us/playready/)
2. [PlayReady Header Specification](https://learn.microsoft.com/en-us/playready/specifications/playready-header-specification)
3. [DASH Content Protection using Microsoft PlayReady](https://learn.microsoft.com/en-us/playready/specifications/mpeg-dash-playready)
4. [PlayReady Content Encryption](https://learn.microsoft.com/en-us/playready/packaging/content-encryption)
5. [PlayReady Content Encryption Modes](https://learn.microsoft.com/en-us/playready/packaging/content-encryption-modes)
6. [PlayReady License Acquisition](https://learn.microsoft.com/en-us/playready/overview/license-acquisition)
7. [PlayReady License and Policies](https://learn.microsoft.com/en-us/playready/overview/license-and-policies)
8. [PlayReady Security Level](https://learn.microsoft.com/en-us/playready/overview/security-level)
9. [Developing SL3000 Clients](https://learn.microsoft.com/en-us/playready/overview/developing-sl3000-products)
10. [PlayReady Output Protection Levels](https://learn.microsoft.com/en-us/playready/overview/output-protection-levels)
11. [PlayReady Key System Strings](https://learn.microsoft.com/en-us/playready/overview/key-system-strings)
12. [PlayReady Plugin for Android Specification](https://learn.microsoft.com/en-us/playready/specifications/playready-plugin-for-android-specification)
13. [PlayReady Key Seed](https://learn.microsoft.com/en-us/playready/specifications/playready-key-seed)
14. [W3C Encrypted Media Extensions](https://www.w3.org/TR/encrypted-media/)
15. [W3C Common Encryption Initialization Data](https://www.w3.org/TR/eme-initdata-cenc/)
16. [Rafi, Shepherd, Markantonakis: A First Look at DRM Systems](https://arxiv.org/abs/2308.00437)
